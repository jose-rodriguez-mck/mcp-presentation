...
- `.sdd/specs/$1/spec.json`, `requirements.md`, `design.md`
- `.sdd/specs/$1/tasks.md` (if exists, for merge mode)
...
- .sdd/specs/$1/*.{json,md}
- .sdd/steering/*.md
- .sdd/settings/rules/tasks-generation.md
- .sdd/settings/rules/tasks-parallel-analysis.md (include only when sequential mode is false)
- .sdd/settings/templates/specs/tasks.md
...
- If `sequential == false`: Read `.sdd/settings/rules/tasks-parallel-analysis.md` for parallel judgement criteria
...
**Write and update**:
- Create/update `.sdd/specs/$1/tasks.md`
...
- **User Message**: "Missing requirements.md or design.md at `.sdd/specs/$1/`"
