...
- If no history found, scan `.sdd/specs/` for features with completed tasks `[x]`

**If feature provided** (`$1` present, `$2` empty):
- Use specified feature
- Detect all completed tasks `[x]` in `.sdd/specs/$1/tasks.md`
...
- Read `.sdd/specs/<feature>/tasks.md` for task list
